 ...
 */
sealed interface SharedHeatingAreasStrategy {
    suspend fun handleHeatingFor(sharedHeater: Heater, areas: Collection<HeatableArea>)
}

/**
 * Base implementation of [SharedHeatingAreasStrategy] providing common validation and utility methods.
 *
 ...
 */
abstract class AbstractSharedHeatingAreasStrategy: SharedHeatingAreasStrategy {
