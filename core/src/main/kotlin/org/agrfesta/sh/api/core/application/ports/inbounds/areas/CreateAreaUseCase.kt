...
interface CreateAreaUseCase {
     ...
     * @return [Either.Right] containing the persisted [Area], or [Either.Left] with an [AreaCreationFailure]
     *         if the area could not be saved (e.g. a duplicate name conflict).
     */
    fun execute(name: String, isIndoor: Boolean? = null): Either<AreaCreationFailure, Area>
}
