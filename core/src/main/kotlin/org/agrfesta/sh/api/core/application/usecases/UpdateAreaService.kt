...
class UpdateAreaService(
    ...
    override fun execute(areaId: UUID, name: String, isIndoor: Boolean): Either<AreaUpdateFailure, Area> =
        areasRepository.update(Area(uuid = areaId, name = name, isIndoor = isIndoor))
}
