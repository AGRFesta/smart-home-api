...
class AreasJdbcAdapter(
    ...
    override fun getAreaById(areaId: UUID): Either<AreaFetchFailure, Area> = try {
    ...
    override fun findAreaByName(name: String): Either<AreaRepositoryError, Area?> = try {
    ...
    override fun save(area: Area): Either<AreaCreationFailure, Unit> = try {
    ...
    override fun getAll(): Either<GetAreasFailure, Collection<Area>> = try {
    ...
    override fun update(area: Area): Either<AreaUpdateFailure, Area> = try {
